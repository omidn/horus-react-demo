  ...
  return (
      <Card style={{ marginTop: 10 }}>
        <CardText>
          ...
          <Indicator labels={['LOC', 'ORG', 'PER', 'DIS']} values={data[selectedIndex].tc_indicators}  />
          <h3>Text Classification (Topic Modeling)</h3>
          <Indicator labels={['LOC', 'ORG', 'PER', 'DIS']} values={data[selectedIndex].tc_indicators_topic}  />
        </CardText>
      </Card>  
  );
}
